## В файле final_project.ipynb содержится код с решением заданий выпускного проекта курса Аналитик Данных Karpov.Courses. Ниже приведены краткие резюме с описанием хода решений.
